# main.py — v4.5 — МАКСИМАЛЬНО ПРОСТОЙ ПЛАНИРОВЩИК
import os
import asyncio
import logging
import sys
...
# === ПРОСТОЙ ПЛАНИРОВЩИК (КАЖДЫЙ ЧАС) ===
async def simple_scheduler():
    """Простой планировщик - начисления каждый час"""
...
async def startup_event():
    ...
    logger.info("🚀 Запуск планировщика при старте...")
...
async def main():
    ...
    # Запускаем только API и бота, планировщик запустится через startup_event
    try:
